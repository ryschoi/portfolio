...
export default function ProjectHeader({ project, sections }: { project: Project, sections: section[] }) {
    return (
        <div className="flex flex-col items-center mb-[6rem] w-full gap-[2rem]">
            {/* TOP TITLE */}
            <div className="mob-mid-w flex flex-col gap-[0.5rem]">
                <h1 className="serif tracking-[-0.3px]">{project.summary}</h1>
            ...
            <div className="flex flex-col gap-[3.5rem] self-center mob-mid-w mt-[2rem] mb-[3rem]">
                ...
                {project.id === 13 &&
                    <p className=" mob-mid-w self-center">I was reached out to by one of my friends to complete some quick design work for this hackathon. I did the UI for the internal admission portal along with the design for the sponsorship package, resulting in partnerships with companies like Vercel and Anthropic.</p>
                }
            </div>
