    ...
    return (
        <div className="flex flex-wrap gap-[0.5rem]">
            <div className="flex flex-col w-full max-w-[655px]">
                <div className="goodnotes-bg-2 rounded flex place-content-center w-full max-w-[655px]">
            ...
            <div className="flex flex-col w-full max-w-[655px]">
                <div className="goodnotes-bg rounded flex place-content-center w-full max-w-[655px]">
                    <div className="self-center my-[4vw]">
