        ...
        <div className="flex justify-center w-full">
            <div className="flex flex-col gap-[2.5rem] w-(--mob-page-w) max-w-[41rem]">
                ...
                <div>
                    ...
                    <p>I use my technical skills and design thinking to create meaningful and useful products, but am a thinker at the core and always aim to understand how things work.</p>
                </div>
