...
export default function ProjectHeader({ project }: { project: Project }) {
    return (
        <div className="flex flex-col items-center gap-[4rem]">
            ...
            <img src={project.frontImage} alt="" width="100%" height="auto" className={project.border === true ? "w-2/3 border" : "w-2/3"} />
            <div className="w-1/2 col40">
                <h2 className="" id="proj-sum">{project.summary}</h2>
                
                {/* MOBILE */}
                <div className="flex flex-col gap-[0.5rem]" id="proj-attributes">
                    {/* project type */}
