        ...
        <div className="project-content">
            ...
            <div className="project-content-rest">
                ...
                <div className="section" id="research">
                    <SectionHeader title="Part 1" description="Research" optional="I started off by researching the current state of the snakebite crisis and how one might prevent fatal encounters with snakes, focusing material specific to Botswana or Africa." />
                ...
                <div className="section" id="wallet-cards">
                    ...
                    <div className="rounded img-bg w-full flex place-content-center">
                        <div className="grid grid-flow-col grid-rows-3 gap-[2rem] my-[4vw]">
                            ...
                            <img src="images/work/snakebite-response/snakebiteWallet3.png" alt="" className="w-[25rem] max-w-[38vw] subtle-shadow" />
                            <img src="images/work/snakebite-response/snakebiteWallet5.png" alt="" className="w-[25rem] max-w-[38vw] subtle-shadow" />
                            <img src="images/work/snakebite-response/snakebiteWallet2.png" alt="" className="w-[25rem] max-w-[38vw] subtle-shadow" />
                            <img src="images/work/snakebite-response/snakebiteWallet4.png" alt="" className="w-[25rem] max-w-[38vw] subtle-shadow" />
                            <img src="images/work/snakebite-response/snakebiteWallet6.png" alt="" className="w-[25rem] max-w-[38vw] subtle-shadow" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col w-full">
