        ...
        <div className="project-content">
            ...
            <div className="project-content-rest">
                ...
                <div className="flex flex-col gap-[3rem] w-full">
                    ...
                    <h2 className="w-(--mid-width) self-center">I learned that a good data visualization is not just about hierarchy and highlighting the most outstanding numbers, but about telling and showing what the numbers actually mean.</h2>
                ...
                <div className="flex flex-col gap-[3rem] w-full">
                    ...
                    <div className="flex flex-col gap-[3rem] w-full align-center">
                        <div className="flex flex-col gap-[1rem]">
                            <h2 className="self-center w-(--mid-width)">Isotypes</h2>
                            <p className="w-(--mid-width) self-center">At first, to highlight the difference in climate conditions, I had illustrations of what those conditions might look like (i.e. more jagged land or more rainfall). However, I found that other than the numbers under the illustrations, there was no way to tangibly grasp the difference in measuremnets.<br /><br />For the final version, I turned the numbers into isotypes with circles representing the actual proportions of the numbers. This way, it is a lot easier to tell the values of each measurement, and just how much the differences are.</p>
                        </div>
